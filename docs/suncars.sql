...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-12-2017 a las 17:08:52
...
INSERT INTO `categorias` (`categoria_id`, `categoria_cod`, `categoria_nombre`, `categoria_http`) VALUES
(2, NULL, 'Alarmas', NULL),
(6, NULL, 'Tranca Palancas', NULL),
(8, NULL, 'Bóveda', NULL),
(9, NULL, 'Papel Ahumado', NULL),
(10, NULL, 'Auto Periquitos', NULL);
...
(1, 'MOficca Amarilito', 'este es el resumen del carrito amarioo', '<p>bbbb esoooo carrito amaririitoto contenido </p><ol><li>sddas fdfdsf</li><li>fas dfdsf asfsd</li><li>fds fdsf dsfds fds</li><li></li></ol>', 1, 'moficca-amarilito', '35430754743.jpg', '63957721377.jpg', '357723498530.jpg', NULL, '2017-12-30 06:42:34', 'servicio', 'tetero', '00002,00006,00008,00010', NULL, 19672417, '63957721377.jpg', '71358716894.jpg', NULL, NULL, NULL, NULL, NULL),
(3, 'safsgfs', 'dfdsafsd', '<p>gfsgfsagfgfd</p>', 0, 'safsgfs', '95421430108.jpg', NULL, NULL, NULL, '2017-12-30 03:23:31', 'servicio', '333', NULL, NULL, 19672417, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Nuevo servivico', 'resumen de lo servicio', '<p>este serviidido detalle</p><p><strong>df dsafdsdsfs f</strong><br></p>', 1, 'nuevo-servivico', '700163878212.jpg', NULL, NULL, NULL, '2017-12-30 03:25:47', 'servicio', 'Nizan', '00006', NULL, 19672417, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(7, 'Prueba final', 'aaa', '<p>aaaa</p>', 1, 'prueba-final', '896284401689.jpg', '', '', NULL, '2017-12-30 06:19:56', 'producto', 'aa', '00006', NULL, 19672417, '', '', NULL, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `categorias`
  MODIFY `categoria_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID Categoría', AUTO_INCREMENT=11;
...
--
ALTER TABLE `contenidos`
  MODIFY `contenido_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID Contenido', AUTO_INCREMENT=9;
