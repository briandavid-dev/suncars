...
class UsuariosSearch extends Usuarios
{
    ...
    public function rules()
    {
        return [
            ...
            [['usuario_nombre', 'usuario_apellido', 'usuario_login', 'usuario_password', 'usuario_fecha_creacion', 'usuario_fecha_modificacion', 'usuario_fecha_ultimo_acceso', 'usuario_email', 'usuario_telefono_1', 'usuario_telefono_2', 'usuario_direccion', 'usuario_perfil', 'usuario_imagen_1', 'usuario_estado', 'usuario_mensaje_publico', 'usuario_genero', 'usuario_fecha_nacimiento', 'authKey', 'accessToken'], 'safe'],
        ];
    }
