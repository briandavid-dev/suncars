                ...
                <div class="row contacts margin-top-25"> 
                    ...
                    <div class="col-md-6 left-information">
                        <div class="contact_information information_head clearfix">
                            <h3 class="margin-bottom-25 margin-top-none" style="color: #FFA019 !important;">INFORMACIÓN DEL CONTACTO</h3>
                            <div class="address clearfix margin-right-25 padding-bottom-40">
                                ...
                                <div class="contact_address">
                                    <p class="margin-bottom-none">Representaciones Suncars,C.A<br>
                                        Santa Mónica,<br>
                                       Av. Arturo Michelena, Quinta. Ami,<br>
                                         Caracas, Dist. Capital.</p>
                                </div>
                            </div>
                        ...
                        <div class="information_hour information_head margin-top-30 xs-padding-bottom-40">
                            <h3 class="margin-bottom-25 margin-top-none" style="color: #FFA019 !important;">HORARIO DE ATENCIÓN AL CLIENTE</h3>
                            <div class="row">
                                ...
                                <div class="col-sm-4 padding-right-none">
                                    <div class="deparment">
                                        <table class="table table-bordered no-border font-12px margin-bottom-none">
                                            <thead>
                                                <tr>
                                                    <td colspan="2"><strong>Bancarios</strong></td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
...
<script src="./themes/automovile/
js/jquery.bxslider.js" type="text/javascript"></script> 
<script src="./themes/automovile/
js/jquery.selectbox-0.2.js" type="text/javascript"></script> 
<script type="text/javascript" src="./themes/automovile/
